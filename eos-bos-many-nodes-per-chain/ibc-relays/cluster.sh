...
#   ./programs/nodeos-eos/nodeos -d var/lib/node1/ --config-dir staging/etc/eosio/node1 --genesis-json staging/etc/eosio/node1/genesis.json
#   ./programs/nodeos-eos/nodeos -d var/lib/node1/ --config-dir staging/etc/eosio/node1
...
#   ./programs/nodeos-bos/nodeos -d var/lib/node2/ --config-dir staging/etc/eosio/node2 --genesis-json staging/etc/eosio/node2/genesis.json
#   ./programs/nodeos-bos/nodeos -d var/lib/node2/ --config-dir staging/etc/eosio/node2
